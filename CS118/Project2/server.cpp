...
int main(int argc, char *argv[])
{
    ...
    my_connection.wait_for_syn_packet();
    string       file_name = my_connection.get_text();
    vector<byte> file_contents{read_file(file_name)};
    my_connection.send_data(file_contents);
}
