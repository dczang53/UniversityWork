...
int main()
{
	...
	double pctHillary = 10.0 * forHillary / numberSurveyed; // altered here
	double pctDonald = 1000.0 * forDonald / numberSurveyed; // altered here
	...
	if (forHillary < forDonald) // altered here
