	...
	while True:												#main game loop
			...
			try:
				...
				if addr[0] == sensor_IP:
					...
					elif distance[0] >= int(HEIGHT-paddle1.height/2):
						paddle1.pos[1] = int(HEIGHT-paddle1.height/2) - 1
					else:
						paddle1.pos[1]= int(paddle1.height/2) + int(((HEIGHT-paddle1.height) / 50) * (distance[0] - 25))
					if two_player:
						if distance[1] <= 25:
							paddle2.pos[1] = int(paddle2.height/2) + 1
						elif distance[1] >= int(HEIGHT-paddle2.height/2):
							paddle2.pos[1] = int(HEIGHT-paddle2.height/2) - 1
						else:
							paddle2.pos[1]= int(paddle2.height/2) + int(((HEIGHT-paddle2.height) / 50) * (distance[1] - 25))
